...
//Environnement
        ...
        this.blocP.create(350, 350, 'bloc_push').setScale(3.96,3.9).setSize(60,60).setOffset(-22);
        this.blocP.create(410, 350, 'bloc_push').setScale(3.96,3.9).setSize(60,60).setOffset(-22);
        this.blocP.create(470, 350, 'bloc_push').setScale(3.96,3.9).setSize(60,60).setOffset(-22);
        this.blocP.create(350, 290, 'bloc_push').setScale(3.96,3.9).setSize(60,60).setOffset(-22);
        this.blocP.create(410, 290, 'bloc_push').setScale(3.96,3.9).setSize(60,60).setOffset(-22);
        this.blocP.create(470, 290, 'bloc_push').setScale(3.96,3.9).setSize(60,60).setOffset(-22);

        this.heart = this.physics.add.staticGroup();
        this.cle = this.physics.add.staticGroup();

        this.tortue = this.physics.add.group();
        this.tortue1 = this.tortue.create(120, 150, 'enemy_turtle').setScale(3.96,3.9).setVelocity(100,0).setBounce(1);
        this.tortue2 = this.tortue.create(600, 450, 'enemy_turtle').setScale(3.96,3.9).setVelocity(100,0).setBounce(1);
        count = 0;
